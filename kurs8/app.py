...
def index(): 
    ...
    <p>Go <a href="{url_for('directories')}">here</a> for list of directories
    <br>
    <img src="{url_for('static',filename='dollar.jpg')}">
    <img src="{url_for('static',filename='euro.jpg')}">
    <br><p>URL DOLLAR: {url_for('static',filename="dollar.jpg")}</p>
    <br><p>URL EURO: {url_for('static',filename='euro.jpg')}</p>
    <br><p>static folder: {app.static_folder}</p>
    <br><p>os static folder: {os.path.join(app.static_folder,r"currencies\euro.jpg")}</p>
    <br><p>is exist static currencies folder? {os.path.exists(os.path.join(app.static_folder,"currencies"))}
    '''
    return menu

@app.route("/directories")
def directories():
    return f"""<h1>DIRECTORIES:</h1>
            <br><p>{BASE_DIR}</p>
            <br><p>{STATIC_DIR}</p>
            <br>Click <a href='{url_for('index')}'>here</a> to return"""
