...
#path_database_config=r"C:\Users\barte\Desktop\python projekty\flask-mobilo-udemy-main\sql_alchemy\config.cfg"  
...
class Vendor(db.Model):
    ...
    product=db.relationship("Product",backref="vendor",lazy="dynamic")
    def __repr__(self):
...
class Product(db.Model):
    ...
    vendor_id=db.Column(db.String(50),db.ForeignKey('vendor.id'))
    
    def __repr__(self):
        return f"Product {self.id}/{self.name}/{self.vendor_id}"
